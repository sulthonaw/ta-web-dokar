...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Des 2022 pada 17.30
...
(22, 'download (6).jpeg|', 'Scoopy', 8000000, 100000, 'Jalan Tanimbar', 'Putih', 'mati', 'Honda Scoopy adalah salah satu merek pedagang sepeda motor Honda di Indonesia skuter matik ini yang di produksi oleh PT Astra Honda Motor.', 'dijual'),
(23, 'download.png|', 'Fazzio', 7000000, 200000, 'Jalan Tanimbar', 'Putih', 'hidup', 'Motor ini adalah skuter matic dengan gaya retro dan jadi sepeda motor hybrid pertama kelas 125cc di Indonesia. Fazzio tersedia dalam dua varian, yaitu Fazzio Neo dan Fazzio Lux dengan pilihan warna yang berbeda.', 'dijual');
...
--
ALTER TABLE `tb_user`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;
COMMIT;
